...
<WebServiceRequestEntity>
   ...
   <name>Get Single Offline Class Invalid id (-2)</name>
   <tag></tag>
   <elementGuidId>20d20cd5-78e7-4594-9e1e-1a87ab356c07</elementGuidId>
   ...
   <restUrl>${variable}/offline-classes/details/-1</restUrl>
