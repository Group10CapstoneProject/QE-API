...
<WebServiceRequestEntity>
   ...
   <name>Get Single Offline Class Invalid id (alfabet)</name>
   <tag></tag>
   <elementGuidId>299f4f92-46a5-4f5d-bf16-4c5df4000424</elementGuidId>
   ...
   <restUrl>${variable}/offline-classes/details/B</restUrl>
