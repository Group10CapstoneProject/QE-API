...
response = WS.sendRequest(findTestObject('Get All Members/1Positif/Get member super admin'), FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyResponseStatusCode(response, 200, FailureHandling.CONTINUE_ON_FAILURE)

response = WS.sendRequest(findTestObject('Get All Members/1Positif/Get member admin token'), FailureHandling.CONTINUE_ON_FAILURE)
