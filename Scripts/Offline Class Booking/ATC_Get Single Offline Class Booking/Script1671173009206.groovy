...
response = WS.sendRequest(findTestObject('Booking Offline Class/Get Single Offline Class Booking/1Positive/Get Single Offline Booking Admin'), 
    FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyResponseStatusCode(response, 200, FailureHandling.CONTINUE_ON_FAILURE)

response = WS.sendRequest(findTestObject('Booking Offline Class/Get Single Offline Class Booking/1Positive/Get Single Offline Booking User'), 
    FailureHandling.CONTINUE_ON_FAILURE)
...
response = WS.sendRequest(findTestObject('Booking Offline Class/Get Single Offline Class Booking/Get Single Offline Booking invalid Token'), 
    FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyResponseStatusCode(response, 401, FailureHandling.CONTINUE_ON_FAILURE)

response = WS.sendRequest(findTestObject('Booking Offline Class/Get Single Offline Class Booking/Get Single Offline invalid HTTP'), 
    FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyResponseStatusCode(response, 405, FailureHandling.CONTINUE_ON_FAILURE)

response = WS.sendRequest(findTestObject('Booking Offline Class/Get Single Offline Class Booking/Get Single Offline minus ID'), 
    FailureHandling.CONTINUE_ON_FAILURE)
