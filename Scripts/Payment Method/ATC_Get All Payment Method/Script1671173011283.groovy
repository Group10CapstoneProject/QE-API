...
response = WS.sendRequest(findTestObject('Payment Method/Get All Payment Method/1Positive/Get All Payment Method User'), 
    FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyResponseStatusCode(response, 200, FailureHandling.CONTINUE_ON_FAILURE)

response = WS.sendRequest(findTestObject('Payment Method/Get All Payment Method/Get All Payment without Token'), FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyResponseStatusCode(response, 400, FailureHandling.CONTINUE_ON_FAILURE)

response = WS.sendRequest(findTestObject('Payment Method/Get All Payment Method/Get All Payment invalid token'), FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyResponseStatusCode(response, 401, FailureHandling.CONTINUE_ON_FAILURE)

response = WS.sendRequest(findTestObject('Payment Method/Get All Payment Method/Get All Payment invalid HTTP'), FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyResponseStatusCode(response, 405, FailureHandling.CONTINUE_ON_FAILURE)

response = WS.sendRequest(findTestObject('Payment Method/Get All Payment Method/Get All Payment invalid URL'), FailureHandling.CONTINUE_ON_FAILURE)
