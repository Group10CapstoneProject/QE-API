...
response = WS.sendRequest(findTestObject('Member Type/Get All Member Types/1Positive/Get All Member Types User'), FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyResponseStatusCode(response, 200, FailureHandling.CONTINUE_ON_FAILURE)

response = WS.sendRequest(findTestObject('Member Type/Get All Member Types/Get All Member Types invalid token'), FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyResponseStatusCode(response, 401, FailureHandling.CONTINUE_ON_FAILURE)

response = WS.sendRequest(findTestObject('Member Type/Get All Member Types/Get All Member type without token'), FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyResponseStatusCode(response, 400, FailureHandling.CONTINUE_ON_FAILURE)

response = WS.sendRequest(findTestObject('Member Type/Get All Member Types/Get All Member type invalid HTTP'), FailureHandling.CONTINUE_ON_FAILURE)

WS.verifyResponseStatusCode(response, 405, FailureHandling.CONTINUE_ON_FAILURE)

response = WS.sendRequest(findTestObject('Member Type/Get All Member Types/Get All Member type invalid URL'), FailureHandling.CONTINUE_ON_FAILURE)
